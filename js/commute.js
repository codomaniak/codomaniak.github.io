...
(function calculateCommute() {
    ...
    const problemStatement = Students commute to university takes ${commuteTimeMinutes} minutes by bus. If he has classes ${daysPerWeek} days a week for ${weeksInSemester} weeks in a semester, how many hours does he spend commuting in total for one semester?;
